...
:root {
  ...
  --text-main: #1e293b;
  --accent-blue: #3b82f6;        /* Light Blue Primary */
  --accent-blue-dark: #2563eb;   /* Darker Blue Hover */
  --accent-delete: #ef4444;      /* Red for delete */
...
.search-container input {
  flex: 1; /* let input expand while button stays fixed */
  max-width: 400px;
...
.pagination-container a:hover {
  background: #0090cc; /* slightly darker blue */
  transform: translateY(-2px);
}
          ...
          <?php foreach (html_escape($users) as $user): ?>
            <tr>
              ...
              <td class="action-links">
                ...
                <a href="<?= site_url('users/delete/'.$user['id']); ?>" class="delete-link" onclick="return confirm('Are you sure?');">Delete</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
